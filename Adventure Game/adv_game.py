...
answer = input(
    ...
    "Which way you would like to go").lower()
...
if answer == "left":
    ...
    answer = input("You come to a bridge, it looks wobbly, "
                   "do you want to cross it or head back (cross/back)?").lower()

    if answer == "back":
        print("You go back and lose")
    elif answer == "cross":
        answer = input("You cross the bridge a meet a stranger. "
                       "Do you talk to them?").lower()

        if answer == "yes":
            print("You talk to the stranger and they give you gold. YOU WIN! ")
        elif answer == "no":
            print("Stranger gets offended. YOU LOSE!")
        else:
            print("Not a valid option. You lose.")
    else:
        print("Not a valid option. You lose.")
